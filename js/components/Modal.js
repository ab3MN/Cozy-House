...
export default class Modal {
  ...
  genereateModal(content) {
    this.backrop = createDomNode(this.backrop, 'div', 'backrop');
    this.modal = createDomNode(this.modal, 'div', 'modal');
    ...
    //Close Button
    this.modalCloseBtn = createDomNode(
      this.modalCloseBtn,
      'span',
      'modal__close-icon'
    );
    ...
    this.modalCloseBtn.addEventListener('click', this.handleClose.bind(this));
  ...
  handleClose() {
    document.querySelector('.backrop').remove();
